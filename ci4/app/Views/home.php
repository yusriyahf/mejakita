...
<head>
    ...
    <script src="/dist/jquery.min.js?v=?<?php echo time(); ?>"></script>
    <script src="/dist/moment.js?v=?<?php echo time(); ?>"></script>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container">
            <a class="navbar-brand" href="#">
                <img src="/img/logo.png" alt="" height="25px" class="d-inline-block align-text-top">
            </a>
